      ...
      <Block>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Block style={styles.sliders}>
            <Block margin={[10, 0]}>
              <Text gray2 style={{ marginBottom: 10 }}>Security Level</Text>
              <Slider
                minimumValue={0}
                maximumValue={1000}
                style={{ height: 19 }}
              ...
              />
              <Text caption gray right>Highest</Text>
            </Block>
            <Block margin={[10, 0]}>
              <Text gray2 style={{ marginBottom: 10 }}>Notifications</Text>
              <Slider
                minimumValue={0}
                maximumValue={5000}
                style={{ height: 19 }}
              ...
              />
              <Text caption gray right>Often</Text>
            </Block>
          </Block>
